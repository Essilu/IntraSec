...
import {
  serializePermissionValues,
  deserializePermissionValues,
...
export default function Roles() {
  const [roles, fetchAllRoles, createRole, updateRole, deleteRole] =
    useRoleStore((state) => [
      state.roles,
      state.fetchAll,
      state.create,
  ...
  const openDeleteModal = (id) => {
    ...
    modals.openConfirmModal({
      ...
      children: (
        <Text size="sm">
          Êtes-vous sûr de vouloir supprimer le rôle <b>{role.name}</b> ? Cette
          action est irréversible et toutes les personnes ayant ce rôle le
          perdront.
        </Text>
      ),
